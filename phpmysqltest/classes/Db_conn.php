...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'nakio';//this will be your WCC username
      $dbUsr = 'nakio';//this will be your WCC username
      $dbPass = 'xa8RVpCqksQ1Hzt';//this will be the password found in the video.
